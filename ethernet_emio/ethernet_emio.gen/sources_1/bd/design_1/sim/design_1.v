...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_aeth_cnt=1,da_axi4_cnt=5,da_board_cnt=9,da_clkrst_cnt=6,da_ps7_cnt=4,synth_mode=None}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.ENET0_GMII_RXD DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.ENET0_GMII_RXD, LAYERED_METADATA undef" *) input [3:0]enet0_gmii_rxd;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.ENET0_GMII_TXD DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.ENET0_GMII_TXD, LAYERED_METADATA undef" *) output [3:0]enet0_gmii_txd;
